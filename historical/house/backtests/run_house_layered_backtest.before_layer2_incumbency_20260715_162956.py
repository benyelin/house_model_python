...
def main() -> None:
    ...
    # Layer 1: presidential baseline plus national environment.
    ...
    validation_lines = [
        ...
        (
            "- Results are provisional because districts "
            "in AL, GA, LA, NC, and NY remain withheld."
        ),
        (
            "- No incumbency, elasticity, candidate quality, "
            "state adjustment, special adjustment, or polling "
            "is included."
        ),
        (
