...
def build_master_features(
    ...
    if elasticity_rows != 398:
        failures.append(
            "Expected 398 historical elasticity estimates matching "
            "current district labels; "
    ...
    report_lines = [
        ...
        (
            "Historical elasticity available on current district labels: "
            f"{elasticity_rows}/435"
        ),
        (
